...
from models import User, Base, Trend
from schemas import UserLogin, UserRegister, TrendResponse
...
def store_trends(category: str, db: Session = Depends(get_db)):
...
from news_services import DOMAINS
